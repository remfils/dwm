...
static const unsigned int remfils_bar_padding = 10;
...
static const char *fonts[]          = {
  ...
  //, "Material Icons:size=10:antialias=true:autohint=true"
...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { col_dark_green, col_gray4,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
        ...
        [SchemeInfoSel]  = { col_gray4, "#0000ff",  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
        [SchemeInfoNorm]  = { col_gray3, col_gray1,  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
};

/* tagging */
static const char *tags[] =         { "1", "2", "3", "4", "5", "6", "7", "8", "9" };
static const char *tagsWithApps[] = {"󰎦", "󰎩", "󰎬", "󰎮", "󰎰", "󰎵", "󰎸", "󰎻", "󰎾" };
...
static const Key keys[] = {
	...
	//{ MODKEY,                       XK_c,      remfils_open_window,     {0} },
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY|ShiftMask,             XK_q,      remfils_open_window,           {0} },
};
